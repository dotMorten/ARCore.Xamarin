...
namespace MyFirstARCoreApp
{
    class PlaneRenderer
    {
        ...
        private static int BYTES_PER_FLOAT = 2;
        private static int BYTES_PER_SHORT = 2;
        private static int COORDS_PER_VERTEX = 3; // x, z, alpha

        private static int VERTS_PER_BOUNDARY_VERT = 2;
        private static int INDICES_PER_BOUNDARY_VERT = 3;
        private static int INITIAL_BUFFER_BOUNDARY_VERTS = 64;
   ...
   */
     ...
     */
    public void drawPlanes(IEnumerable<Plane> allPlanes, Pose cameraPose,
